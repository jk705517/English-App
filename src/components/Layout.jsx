...
function Layout() {
    ...
    return (
        <div className="flex h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
            ...
            <aside className="hidden md:flex w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex-col shadow-sm">
                {/* Logo 区域 */}
                <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">BiuBiu English</h1>
                            <p className="text-xs text-gray-500 dark:text-gray-400">刷视频学英语</p>
                        </div>
                    </div>
                </div>
